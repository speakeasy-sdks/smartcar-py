...
class Cadillac:
    ...
    def get_charge_time(self, vehicle_id: str) -> operations.GetCadillacChargeTimeResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getCadillacChargeTime', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetCadillacChargeTimeResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_voltage(self, vehicle_id: str) -> operations.GetCadillacVoltageResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getCadillacVoltage', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetCadillacVoltageResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
