...
class CompassDirectionEnum(str, Enum):
...
class Compass:
    ...
    direction: Optional[CompassDirectionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('direction'), 'exclude': lambda f: f is None }})
    r"""The direction the vehicle is traveling."""
