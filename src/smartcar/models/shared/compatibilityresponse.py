...
class CompatibilityResponse:
    ...
    reason: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reason'), 'exclude': lambda f: f is CompatibilityResponse.UNSET }})
