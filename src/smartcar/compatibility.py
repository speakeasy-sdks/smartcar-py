...
class Compatibility:
    ...
    def list_compatibility(self, country: Optional[str] = None, scope: Optional[str] = None, vin: Optional[str] = None) -> operations.ListCompatibilityResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='listCompatibility', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        query_params = { **utils.get_query_params(operations.ListCompatibilityRequest, request), **query_params }
        ...
        res = operations.ListCompatibilityResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
