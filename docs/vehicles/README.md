...
res = s.vehicles.batch('molestiae', [
    '/odometer',
    '/odometer',
    '/odometer',
    '/odometer',
...
res = s.vehicles.disconnect('placeat')
...
res = s.vehicles.get_engine_oil('iusto')
...
res = s.vehicles.get_fuel_tank('excepturi')
...
res = s.vehicles.get_odometer('nisi')
...
res = s.vehicles.get_permissions('recusandae', 836079, 71036)
...
res = s.vehicles.get_tire_pressure('quis')
...
res = s.vehicles.get_vin('veritatis')
...
res = s.vehicles.list_vehicles(648172, 20218)
...
res = s.vehicles.lock_unlock('ipsam', shared.SecurityAction(
    action=shared.SecurityActionActionEnum.UNLOCK,
))
