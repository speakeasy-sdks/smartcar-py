...
res = s.webhooks.subscribe(vehicle_id='Chicken', webhook_id='Cedi', webhook_info=shared.WebhookInfo(
...
res = s.webhooks.unsubscribe(vehicle_id='deposit', webhook_id='royal')
