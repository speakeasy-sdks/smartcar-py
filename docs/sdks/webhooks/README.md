...
res = s.webhooks.subscribe(vehicle_id='repellendus', webhook_id='sapiente', webhook_info=shared.WebhookInfo(
...
res = s.webhooks.unsubscribe(vehicle_id='quo', webhook_id='odit')
