...
res = s.webhooks.subscribe(vehicle_id='<value>', webhook_id='<value>', webhook_info=shared.WebhookInfo(
...
res = s.webhooks.unsubscribe(vehicle_id='<value>', webhook_id='<value>')
