...
res = s.vehicles.batch(vehicle_id='molestiae', request_body=[
    '/odometer',
    '/odometer',
    '/odometer',
    '/odometer',
...
res = s.vehicles.disconnect(vehicle_id='placeat')
...
res = s.vehicles.get(vehicle_id='voluptatum')
...
res = s.vehicles.get_engine_oil(vehicle_id='iusto')
...
res = s.vehicles.get_fuel_tank(vehicle_id='excepturi')
...
res = s.vehicles.get_odometer(vehicle_id='nisi')
...
res = s.vehicles.get_permissions(vehicle_id='recusandae', limit=836079, offset=71036)
...
res = s.vehicles.get_tire_pressure(vehicle_id='quis')
...
res = s.vehicles.get_vin(vehicle_id='veritatis')
...
res = s.vehicles.list_vehicles(limit=648172, offset=20218)
...
res = s.vehicles.lock_unlock(vehicle_id='ipsam', security_action=shared.SecurityAction(
